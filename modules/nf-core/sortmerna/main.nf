process SORTMERNA {
    ...
    if (meta.single_end) {
        ...
        cp non_rRNA_reads.f*q.gz ${prefix}.non_rRNA.fastq.gz
        cp rRNA_reads.log ${prefix}.sortmerna.log
        ...
        cp non_rRNA_reads_fwd.f*q.gz ${prefix}_1.non_rRNA.fastq.gz
        cp non_rRNA_reads_rev.f*q.gz ${prefix}_2.non_rRNA.fastq.gz
        cp rRNA_reads.log ${prefix}.sortmerna.log
